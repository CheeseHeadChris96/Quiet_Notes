(function (root) {
  ...
  function validate(data) {
    ...
    return data.map(n => {
      ...
      if(n.folderId!==undefined&&(typeof n.folderId!=='string'||!n.folderId))throw new Error('Invalid note folder.');
      ...
      ids.add(n.id);
      return {...(n.folderId?{folderId:n.folderId}:{}), id:n.id, title:n.title.slice(0,200), body:n.body, color:n.color, created:n.created, updated:n.updated, pinned:!!n.pinned, deleted:!!n.deleted, ...(techs?{technologies:techs}:{}), ...(n.client && n.client.trim().toLowerCase() !== 'generic' ? {client:n.client.trim().replace(/\s+/g,' ')} : {}), ...(typeof n.html === 'string' ? {html:n.html} : {})};
    });
  }
